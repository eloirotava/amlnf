...
struct aml_nftl_dev {
	...
	struct timespec64	ts_write_start;
	...
	int                   init_flag;
	int                   reboot_flag;
	uint32(*read_data)(struct aml_nftl_dev *nftl_dev, unsigned long block, unsigned int nblk, unsigned char *buf);
	uint32(*write_data)(struct aml_nftl_dev *nftl_dev, unsigned long block, unsigned int nblk, unsigned char *buf);
	uint32(*discard_data)(struct aml_nftl_dev *nftl_dev, unsigned long block, unsigned int nblk);
...
struct aml_nftl_blk {
	...
	uint32(*read_data)(struct aml_nftl_blk *nftl_blk, unsigned long block, unsigned int nblk, unsigned char *buf);
	uint32(*write_data)(struct aml_nftl_blk *nftl_blk, unsigned long block, unsigned int nblk, unsigned char *buf);
	uint32(*discard_data)(struct aml_nftl_blk *nftl_blk, unsigned long block, unsigned int nblk);
