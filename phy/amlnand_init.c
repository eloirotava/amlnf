...
#endif
{
	...
	pr_debug("amlnf: pinctrl ok\n");
#endif

	//Step 1: init hw controller
	pr_debug("amlnf: hwcontroller_init\n");
	...
	pr_debug("amlnf: hwcontroller_init ok\n");

	//Step 2: init aml_chip operation
	pr_debug("amlnf: init_operation\n");
	...
	pr_debug("amlnf: init_operation ok\n");

	//Step 3: get nand flash and get hw flash information
	pr_debug("amlnf: chip_init\n");
	...
	pr_debug("amlnf: chip_init ok\n");

	//Step 4: get device configs
	pr_debug("amlnf: get_dev_configs\n");
	...
	pr_debug("amlnf: get_dev_configs ok\n");

	//Step 5: register nand device, and config device information
	pr_debug("amlnf: phydev_init\n");
